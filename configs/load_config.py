...
class LoadConfig:
    ...
    def load_directories(self, app_config):
        ...
        self.data_product_directory = (
            app_config['directories']['data_product_directory']
        )
        self.database_product_directory = (
            app_config['directories']['database_product_directory']
        )
